...
int main()
{
    ...
    Sprite ceuSprite("../src/RespostaAoDesafioM4/ceu.png",
                     glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f),
                     glm::vec2(WIDTH, HEIGHT),
                     0.0f);

    Sprite nuvem1Sprite("../src/RespostaAoDesafioM4/nuvem_1.png",
                        glm::vec2(WIDTH / 2.0f, HEIGHT * 0.3f), 
                        glm::vec2(WIDTH, HEIGHT * 0.4f),       
                        0.0f);

    Sprite nuvem2Sprite("../src/RespostaAoDesafioM4/nuvem_2.png",
                        glm::vec2(WIDTH / 2.0f, HEIGHT * 0.25f),
                        glm::vec2(WIDTH * 0.7f, HEIGHT * 0.2f), 
                        0.0f);

    Sprite pedrasSprite("../src/RespostaAoDesafioM4/pedras.png",
                        glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f), 
                        glm::vec2(WIDTH, HEIGHT),              
                        0.0f);

    Sprite frenteSprite("../src/RespostaAoDesafioM4/frente.png",
                         glm::vec2(WIDTH / 2.0f, HEIGHT / 2.0f), 
                         glm::vec2(WIDTH, HEIGHT),               
                         0.0f);
    ...
    sprites.push_back(std::move(ceuSprite));
    sprites.push_back(std::move(nuvem1Sprite));
    sprites.push_back(std::move(nuvem2Sprite));
    sprites.push_back(std::move(pedrasSprite));
    sprites.push_back(std::move(frenteSprite));
